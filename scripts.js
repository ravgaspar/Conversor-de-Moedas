// Função que busca a cotação atual da moeda.
async function getCurrencyQuote(currency) {
	try {
	  ...
	  alert("Erro ao obter a cotação atual da moeda selecionada. Por favor verifique ou tente novamente mais tarde.");
	}
  }
...
// Manipulação do input amount para receber somente números.
amount.addEventListener("input", () => {
	const hasCharactersRegex = /\D+/g;
	amount.value = amount.value.replace(hasCharactersRegex, "");
});

// Captura do evento do botão "SUBMIT" (ENVIAR) do formulário.
